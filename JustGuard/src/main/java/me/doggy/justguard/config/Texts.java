...
public class Texts
{
    ...
    //public static final String NO_PERMISSION_TO_CLAIM_REGION_OF_TYPE = "no-permission-to-claim-region-of-type";
    //public static final String NO_PERMISSION_TO_CLAIM_REGION_INTERSECT_WITH_REGION_OF_TYPE = "no-permission-to-claim-region-intersect-with-region-of-type";
